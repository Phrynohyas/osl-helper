...
OSL Helper is a web tool to help you plan OSL and highlight placement for miniature painting.
...
### 2. Advanced scenario (multiple light sources)
...
- Move & Resize Light Sources
	- **Move:** press and drag a light on the canvas.
	- **Resize:** drag the small white square in the bottom-right corner of the light.

- Change Light Source Colors
	- In the **Light Sources** list, use the **color picker** next to each light.
	- The light on the canvas updates to match the selected color.

- Remove a Light Source
	- **Double-tap / double-click** a light on the canvas to remove the Light Source
	-- It will also disappear from the list and free up a slot.
...
This application does not store any data (including cookies) on the user’s device, nor does it track any user activity.